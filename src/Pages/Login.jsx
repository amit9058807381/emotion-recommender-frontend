      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-4">
          ...
          <h1 className="text-lg font-bold">
            Welcome back to <span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">EmotiRecommend</span>
          </h1>
          <p className="text-gray-400 text-xs mt-1">Login to see what matches your mood today</p>
        </div>
